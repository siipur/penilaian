...
switch($act) {
	...
	$tampil = mysql_query("SELECT * FROM tbl_guru WHERE nip='$_SESSION[namauser]'");
	...
	<div class=\"jumbotron\">
		...
		<button class=\"btn btn-warning\">
			<a href='?module=profile&act=editmydata&id=$data[nip]' class=\"edit\" data-toggle=\"tooltip\" data-placement=\"right\" title=\"klik untuk edit !\">
	...
	echo "
		<legend><font color=\"green\">Edit My Data</font></legend>
		...
		<form class=\"form-horizontal\" role=\"form\" method=POST action=$aksi?module=profile&act=update enctype=\"multipart/form-data\">
			...
			<div class=\"form-group\">
				...
				<div class=\"col-sm-6\">          
					<input type=\"text\" class=\"form-control\" name='nip' value='$r[nip]' disabled>
				</div>
			</div>
			...
			<div class=\"form-group\">
				...
				<label class=\"control-label col-sm-1\">:</label>
				<div class=\"col-sm-6\">          
					<input type=\"text\" class=\"form-control\" name='nuptk' value='$r[nuptk]' disabled>
				</div>
			</div>
			...
			<div class=\"form-group\">
				...
				<label class=\"control-label col-sm-1\">:</label>
				<div class=\"col-sm-6\">          
					<img src=\"images/$r[img_guru]\" class=\"img-rounded\" alt=\"foto\" width=200 height=254> 
